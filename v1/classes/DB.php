...
class DB
{
    ...
    public function __construct()
    {
        ...
        try {
            $this->link = new mysqli( Constants::DB_HOST, Constants::DB_USER, Constants::DB_PASS, Constants::DB_NAME );
    ...
    public function parseObjectToParams($params, $f = '=', $r = 'AND') {
